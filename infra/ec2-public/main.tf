...
resource "aws_autoscaling_group" "this" {
  ...
  health_check_type         = var.health_check_type        # "EC2" or "ELB"
  ...
  # Attach to NLB Target Groups if provided
...
# Optional scaling policies/alarms can be added later
